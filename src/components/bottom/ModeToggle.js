...
class ModeToggle extends Component {
    ...
    render() {
        return (
            <div role="button" id="toggle-mode" className="toggle-mode" onClick={ this.handleClick }>
                { localStorage.getItem('theme') === 'light-mode' ?
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="moon-svg">
                ...
                :
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="sun-svg">
